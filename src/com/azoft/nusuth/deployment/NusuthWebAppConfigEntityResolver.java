 ...
 */
public class NusuthWebAppConfigEntityResolver implements EntityResolver {
    ...
    public InputSource resolveEntity(String publicId, String systemId) throws java.io.IOException, SAXException {
        return new InputSource(getClass().getClassLoader().getResourceAsStream("com/azoft/nusuth/deployment/nusuth-web-app-config.dtd"));
    }
}