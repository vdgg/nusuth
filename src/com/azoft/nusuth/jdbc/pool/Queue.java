 ...
 * means of this queue.
 *
 * This class is from jsync (Java synchronization classes).
 *
 * @author K.A. Knizhnik
 *
 * @version 0.5.5
...
public class Queue {
    ...
    protected final static synchronized QueueItem createItem(Object obj) {
        QueueItem item;
    ...
    protected final static synchronized void freeItem(QueueItem item) {
